  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((ReminderReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectReminderReceiver(UnsafeCasts.<ReminderReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
