...
public abstract class Hilt_StatisticsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StatisticsFragment() {
    super();
  }

  Hilt_StatisticsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StatisticsFragment_GeneratedInjector) this.generatedComponent()).injectStatisticsFragment(UnsafeCasts.<StatisticsFragment>unsafeCast(this));
    }
  }
