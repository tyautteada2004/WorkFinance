...
public abstract class Hilt_ShiftFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShiftFragment_GeneratedInjector) this.generatedComponent()).injectShiftFragment(UnsafeCasts.<ShiftFragment>unsafeCast(this));
    }
  }
