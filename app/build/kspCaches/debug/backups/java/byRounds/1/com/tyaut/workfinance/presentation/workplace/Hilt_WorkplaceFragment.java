...
public abstract class Hilt_WorkplaceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WorkplaceFragment() {
    super();
  }

  Hilt_WorkplaceFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkplaceFragment_GeneratedInjector) this.generatedComponent()).injectWorkplaceFragment(UnsafeCasts.<WorkplaceFragment>unsafeCast(this));
    }
  }
