...
public abstract class Hilt_ActualShiftInputBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ActualShiftInputBottomSheet() {
    super();
  }

  Hilt_ActualShiftInputBottomSheet(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ActualShiftInputBottomSheet_GeneratedInjector) this.generatedComponent()).injectActualShiftInputBottomSheet(UnsafeCasts.<ActualShiftInputBottomSheet>unsafeCast(this));
    }
  }
