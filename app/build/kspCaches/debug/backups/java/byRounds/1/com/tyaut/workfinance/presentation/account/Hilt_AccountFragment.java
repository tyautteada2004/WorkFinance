...
public abstract class Hilt_AccountFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AccountFragment() {
    super();
  }

  Hilt_AccountFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AccountFragment_GeneratedInjector) this.generatedComponent()).injectAccountFragment(UnsafeCasts.<AccountFragment>unsafeCast(this));
    }
  }
