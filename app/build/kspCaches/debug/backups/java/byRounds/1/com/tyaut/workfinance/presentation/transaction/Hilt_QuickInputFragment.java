...
public abstract class Hilt_QuickInputFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuickInputFragment() {
    super();
  }

  Hilt_QuickInputFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuickInputFragment_GeneratedInjector) this.generatedComponent()).injectQuickInputFragment(UnsafeCasts.<QuickInputFragment>unsafeCast(this));
    }
  }
