...
public abstract class Hilt_ShiftInputBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShiftInputBottomSheet() {
    super();
  }

  Hilt_ShiftInputBottomSheet(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShiftInputBottomSheet_GeneratedInjector) this.generatedComponent()).injectShiftInputBottomSheet(UnsafeCasts.<ShiftInputBottomSheet>unsafeCast(this));
    }
  }
